...
\begin{document}
	...
	Zak³adaj¹c znacznie mniejsze zu¿ycie pamiêci i oszczêdnoœæ obliczeñ algorytmu EigenFace w porównaniu do FisherFace jest to algorytm mniej obci¹¿aj¹cy mikrokomputer Raspberry. Zale¿y jednak nam podczas realizacji projektu, by poziom b³êdów by³ jak najni¿szy, wiêc do rozpoznawaniu twarzy u¿yjemy algorytmu FisherFace.
\end{document}