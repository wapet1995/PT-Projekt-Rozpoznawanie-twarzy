...
\begin{document}
	...
	Zak³ada siê nastêpuj¹ce wymagania poza funkcjonalne systemu:
	\begin{itemize*}
...
\newpage
	...
	Zak³adaj¹c znacznie mniejsze zu¿ycie pamiêci i oszczêdnoœæ obliczeñ algorytmy EigenFace ni¿ FisherFace, zale¿y jednak nam podczas realizacji projektu, by poziom b³êdów by³ jak najni¿szy. Projekt zostanie realizowany algorytmem FisherFace.
\end{document}